...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Sheyam Sundar New1");
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Sheyam");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Sundar New1");
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("sundarsheyam1@yopmail.com");
		...
		System.out.println("Title of the page after creating the lead: "+driver.getTitle());
		//Click on Duplicate button
		driver.findElement(By.linkText("Duplicate Lead")).click();
		//Clear the CompanyName Field using .clear() And Enter new CompanyName
		driver.findElement(By.id("createLeadForm_companyName")).clear();
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("SSS");
		//Clear the FirstName Field using .clear() And Enter new FirstName
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("SSS");
		
		//Click on Create Lead Button
		driver.findElement(By.name("submitButton")).click();
		
		//Get the Title of Resulting Page
		System.out.println("Title of the page after creating the lead(Duplicate): "+driver.getTitle());
		driver.close();
